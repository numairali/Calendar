...
import { GivenDataComponent } from 'app/entities/given-data/given-data.component';
...
describe('Component Tests', () => {
  describe('GivenData Management Component', () => {
    let comp: GivenDataComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GivenDataComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.givenData[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
